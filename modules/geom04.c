...
void init_gamma04()
{
    ...
    // gamma5
    gsl_matrix_complex_set(gamma[5], 0, 2, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gamma[5], 1, 3, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gamma[5], 2, 0, gsl_complex_rect(0.0, -1.0));
    gsl_matrix_complex_set(gamma[5], 3, 1, gsl_complex_rect(0.0, -1.0));
     
    // gamma6
    gsl_matrix_complex_set(gamma[6], 0, 2, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gamma[6], 1, 3, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gamma[6], 2, 0, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gamma[6], 3, 1, gsl_complex_rect(1.0, 0.0));
