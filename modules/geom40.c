...
void init_gamma40()
{
    ...
    // gamma4
    gsl_matrix_complex_set(gamma[4], 0, 0, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gamma[4], 1, 1, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gamma[4], 2, 2, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gamma[4], 3, 3, gsl_complex_rect(-1.0, 0.0));
     
    // gamma5
    gsl_matrix_complex_set(gamma[5], 0, 1, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gamma[5], 1, 0, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gamma[5], 2, 3, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gamma[5], 3, 2, gsl_complex_rect(1.0, 0.0));
