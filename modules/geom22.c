...
void init_gamma22()
{
    ...
    // gammaL0
    gsl_matrix_complex_set(gamma[4], 0, 2, gsl_complex_rect(-1.0, 0.0));
    gsl_matrix_complex_set(gamma[4], 1, 3, gsl_complex_rect(1.0, -0.0));
    gsl_matrix_complex_set(gamma[4], 2, 0, gsl_complex_rect(1.0, 0.0));
    gsl_matrix_complex_set(gamma[4], 3, 1, gsl_complex_rect(-1.0, 0.0));
 
    // gammaL1
    gsl_matrix_complex_set(gamma[5], 0, 3, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gamma[5], 1, 2, gsl_complex_rect(-0.0, -1.0));
    gsl_matrix_complex_set(gamma[5], 2, 1, gsl_complex_rect(0.0, -1.0));
    gsl_matrix_complex_set(gamma[5], 3, 0, gsl_complex_rect(0.0, 1.0));
 
    // gammaL2
    gsl_matrix_complex_set(gamma[6], 0, 1, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gamma[6], 1, 0, gsl_complex_rect(0.0, 1.0));
    gsl_matrix_complex_set(gamma[6], 2, 3, gsl_complex_rect(0.0, -1.0));
    gsl_matrix_complex_set(gamma[6], 3, 2, gsl_complex_rect(0.0, -1.0));
