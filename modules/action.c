...
double delta2_auto(gsl_matrix_complex* dM, int uM)
{
    ...
    free(array20);
    gsl_complex trdM = trace(dM);
    pfac = gsl_complex_rect(dimG*dim*(1*1+1*1), 0);
    res = gsl_complex_add(res, gsl_complex_mul(trdMdM, pfac));
    pfac = gsl_complex_rect(dimG*(2*e[uM]), 0);
...
double delta4(gsl_matrix_complex* dM, int uM)
{
    ...
    for(i2[0]=0; i2[0]<nHL; i2[0]++)
    {
        for(i2[1]=0; i2[1]<nHL; i2[1]++)
        {
            ...
            gsl_matrix_complex* gamma_i2_0__gamma_i2_1__ = gsl_matrix_complex_alloc(dimG, dimG);
            matrix_multiprod(array20, 2, gamma_i2_0__gamma_i2_1__);
            gsl_complex trgamma_i2_0__gamma_i2_1__ = trace(gamma_i2_0__gamma_i2_1__);
            gsl_matrix_complex_free(gamma_i2_0__gamma_i2_1__);
            free(array20);
            ...
            free(array215);
            pfac = gsl_complex_rect(dim*(1*e[i2[0]]*e[i2[1]]+1*e[i2[0]]*e[i2[1]]+1*e[i2[0]]*e[i2[1]]+1*1), 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__dMdMMAT_i2_1__), pfac));
            pfac = gsl_complex_rect(1*e[i2[1]]+1*e[i2[0]]+1*e[i2[1]]+1*e[i2[0]]+1*e[i2[1]]+1*e[i2[0]]+1*e[i2[1]]+1*e[i2[0]], 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__), trMAT_i2_1__dMdM), pfac));
            pfac = gsl_complex_rect(1*e[i2[0]]+1*e[i2[1]]+1*e[i2[0]]+1*e[i2[1]]+1*e[i2[0]]+1*e[i2[1]]+1*e[i2[0]]+1*e[i2[1]], 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__dMdM), trMAT_i2_1__), pfac));
            pfac = gsl_complex_rect(1*1+1*e[i2[0]]*e[i2[1]]+1*1+1*e[i2[0]]*e[i2[1]]+1*1+1*e[i2[0]]*e[i2[1]]+1*1+1*e[i2[0]]*e[i2[1]], 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__MAT_i2_1__), trdMdM), pfac));
            pfac = gsl_complex_rect(2*e[uM]*e[i2[0]]*e[i2[1]]+1*e[uM]*e[i2[0]]*e[i2[1]]+1*e[uM]*e[i2[0]]*e[i2[1]]+2*e[uM]*e[i2[0]]*e[i2[1]]+2*e[uM], 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__dMMAT_i2_1__), trdM), pfac));
            pfac = gsl_complex_rect(2*e[uM]*e[i2[1]]+2*e[uM]*e[i2[0]]+1*e[uM]*e[i2[1]]+1*e[uM]*e[i2[0]]+1*e[uM]*e[i2[1]]+1*e[uM]*e[i2[0]]+2*e[uM]*e[i2[1]]+2*e[uM]*e[i2[0]]+2*e[uM]*e[i2[1]]+2*e[uM]*e[i2[0]], 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__dM), trMAT_i2_1__dM), pfac));
            pfac = gsl_complex_rect(2*e[uM]+1*e[uM]+1*e[uM]+2*e[uM]+2*e[uM]*e[i2[0]]*e[i2[1]], 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__MAT_i2_1__dM), trdM), pfac));
            pfac = gsl_complex_rect(dim*(1*1+1*1+1*1+1*e[i2[0]]*e[i2[1]]), 0);
            res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(trgamma_i2_0__gamma_i2_1__, trMAT_i2_0__MAT_i2_1__dMdM), pfac));
    ...
    {
        gsl_matrix_complex** array30 = malloc(2*sizeof(gsl_matrix_complex*));
        array30[0] = gamma[i3[0]];
        array30[1] = gamma[uM];
        gsl_matrix_complex* gamma_i3_0__gamma_uM_ = gsl_matrix_complex_alloc(dimG, dimG);
        matrix_multiprod(array30, 2, gamma_i3_0__gamma_uM_);
        gsl_complex trgamma_i3_0__gamma_uM_ = trace(gamma_i3_0__gamma_uM_);
        gsl_matrix_complex_free(gamma_i3_0__gamma_uM_);
        free(array30);
        ...
        res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(trgamma_i3_0__gamma_uM_, trMAT_i3_0__dMdMdM), pfac));
        pfac = gsl_complex_rect(1*e[uM]+1*e[i3[0]]+1*e[uM]+1*e[i3[0]]+1*e[uM]+1*e[i3[0]]+1*e[uM]+1*e[i3[0]], 0);
        res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i3_0__gamma_uM_, trMAT_i3_0__), trdMdMdM), pfac));
        pfac = gsl_complex_rect(3*e[i3[0]]+3*e[uM]+2*e[i3[0]]+1*e[uM]+1*e[i3[0]]+2*e[uM]+1*e[i3[0]]+2*e[i3[0]]+2*e[uM]+1*e[uM]+3*e[i3[0]]+3*e[uM], 0);
        res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i3_0__gamma_uM_, trMAT_i3_0__dMdM), trdM), pfac));
        ...
        res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(gsl_complex_mul(trgamma_i3_0__gamma_uM_, trMAT_i3_0__dM), trdMdM), pfac));
    }
    free(i3);
    ...
    matrix_multiprod(array40, 4, dMdMdMdM);
    gsl_complex trdMdMdMdM = trace(dMdMdMdM);
    gsl_matrix_complex_free(dMdMdMdM);
    free(array40);
    gsl_complex trdM = trace(dM);
    gsl_matrix_complex** array42 = malloc(3*sizeof(gsl_matrix_complex*));
    array42[0] = dM;
    array42[1] = dM;
    array42[2] = dM;
    gsl_matrix_complex* dMdMdM = gsl_matrix_complex_alloc(dim, dim);
    matrix_multiprod(array42, 3, dMdMdM);
    gsl_complex trdMdMdM = trace(dMdMdM);
    gsl_matrix_complex_free(dMdMdM);
    free(array42);
    gsl_matrix_complex** array43 = malloc(2*sizeof(gsl_matrix_complex*));
    array43[0] = dM;
    array43[1] = dM;
    gsl_matrix_complex* dMdM = gsl_matrix_complex_alloc(dim, dim);
    matrix_multiprod(array43, 2, dMdM);
    gsl_complex trdMdM = trace(dMdM);
    gsl_matrix_complex_free(dMdM);
    free(array43);
    pfac = gsl_complex_rect(dimG*dim*(1*1+1*1), 0);
    res = gsl_complex_add(res, gsl_complex_mul(trdMdMdMdM, pfac));
    pfac = gsl_complex_rect(dimG*(4*e[uM]+4*e[uM]), 0);
    res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(trdM, trdMdMdM), pfac));
    pfac = gsl_complex_rect(dimG*(6*1), 0);
    res = gsl_complex_add(res, gsl_complex_mul(gsl_complex_mul(trdMdM, trdMdM), pfac));
